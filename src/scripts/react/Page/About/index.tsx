      ...
      <div className="content">
        ...
        <div className="left">
          ...
          <h2>
            ...
            DAO-voting for creative and career development decisions, sharing in
            the revenue generated by NFTs and intellectual property.
            <br />
            <br />
            SuiGals NFT Holders will participate, invest, and co-develop the
            virtual idols' ownership -- just like owning the SM Entertainment in
            the web3 world.
          </h2>
          ...
          <h2>
            ...
            <br />
            <br />
            Simple words, it’s just like owning the SM Entertainment in the web3
            world.
          </h2>
        </div>
        {/* <div className="right">
