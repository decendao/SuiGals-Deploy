      ...
      <div id="dapp">
        {
          props.isConnect ? (
            ...
            <div className="no-wallet">
              <button className="primary" disabled onClick={() => {}}>The Face of Sui</button>
              <div className="use-block-explorer">
                SuiGal NFT <span className="emoji">❤️</span><span className="emoji"></span>
              </div>
            </div>
          )
        }
